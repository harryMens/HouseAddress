...
import static com.google.android.houseaddress.network.Static.GEOCODE_API_KEY;
import static com.google.android.houseaddress.network.Static.OPEN_DIRECTION_KEY;
...
import com.google.android.houseaddress.network.directions.HouseGenerator;
...
public class Repository {
    ...
    public Call<HouseAddress> getHouseAddress(double latitude, double longitude){
        return HouseGenerator.request.houseAddress("geojson", latitude, longitude);
    }
